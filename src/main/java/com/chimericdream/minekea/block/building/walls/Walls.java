...
public class Walls implements ModThingGroup {
    ...
    static {
        ...
        WALL_BLOCKS.add(REGISTRY_HELPER.registerWithItem(WallBlock.makeId("gold_block"), () -> new WallBlock(new BlockConfig().material("gold_block").materialName("Gold Block").ingredient(Blocks.GOLD_BLOCK)), DEFAULT_WALL_SETTINGS));
