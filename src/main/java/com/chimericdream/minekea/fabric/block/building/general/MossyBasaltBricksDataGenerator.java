...
public class MossyBasaltBricksDataGenerator extends ChimericLibBlockDataGenerator {
    public static Block BLOCK = BuildingBlocks.MOSSY_BASALT_BRICKS.get();
    ...
    public void configureRecipes(HolderLookup.Provider registryLookup, RecipeOutput exporter, RecipeProvider generator) {
        generator.shapeless(RecipeCategory.BUILDING_BLOCKS, BLOCK, 1)
            ...
            .unlockedBy(RecipeProvider.getHasName(Blocks.VINE),
                generator.has(Blocks.VINE))
            .save(exporter);
    ...
    public void configureTranslations(HolderLookup.Provider registryLookup, FabricLanguageProvider.TranslationBuilder translationBuilder) {
        TranslationUtils.addBlockAndItem(translationBuilder, BLOCK, "Mossy Basalt Bricks");
    }
